...
DEEP_COLS = [
    ...
    "modelo_negocio", "competencia_local", "competencia_global", "stage",
    "funding_raised", "mercado_actual", "valida_idea_propia", "fundadores",
    "redes_sociales", "fit_yc", "tipo_candidato",
]
