...
QUERIES: dict[str, dict[str, list[str]]] = {
    ...
    "ops_b2b": {
        "es": ['pymes facturación cobranza', 'ERP pymes digitalización', 'logística última milla', 'compras B2B proveedores'],
        "pt": ['pequenas empresas faturamento cobrança', 'ERP pequenas empresas digitalização', 'logística última milha', 'compras B2B fornecedores'],
        "en": ['SMB invoicing collections', 'ERP small business', 'last mile logistics', 'B2B procurement suppliers']},
    "comercio": {
