...
GN_FEEDS: dict[str, list[str]] = {
    ...
    "gn_tradicional_negocios": _many(['site:bizjournals.com "second location"', 'site:bizjournals.com "family-owned"',
                                      'site:inc.com "family-owned"', 'site:qsrmagazine.com franchise growth',
                                      'site:smallbiztrends.com', 'site:starterstory.com']),
    "gn_tradicional_es": _many(['"empresa familiar" "nuevo formato"', 'emprendedor "abrió su" local', '"pyme del año"',
                               ...
                               **_ES),
    "gn_tradicional_pt": _many(['padaria rede expande unidades', 'lavanderia franquia', 'franquia cresce faturamento',
                                'supermercado nova loja expansão', 'empreendedor franquia cresce', '"empresa familiar" cresce lojas'], **_PT),
